...
/**
 *  請求に関するユーザの種類 ユニットテスト
 */

class DeliveryOfficeChargeUserTypeTest extends TestCase
{
    private $section = "請求に関するユーザの種類";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/delivery-office-charge-user-type" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/delivery-office-charge-user-type/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
