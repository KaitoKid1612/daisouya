...
class WebContactTypeTest extends TestCase
{
    private $section = "お問い合わせタイプ";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/web-contact-type" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/web-contact-type/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
