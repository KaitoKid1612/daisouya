...
/**
 * 依頼者へのレビュー公開ステータス ユニットテスト
 */

class DeliveryOfficeTaskReviewPublicStatusTest extends TestCase
{
    private $section = "依頼者へのレビュー公開ステータス";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/delivery-office-task-review-public-status" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/delivery-office-task-review-public-status/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
