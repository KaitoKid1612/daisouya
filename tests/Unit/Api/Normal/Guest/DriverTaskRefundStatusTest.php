...
/**
 * 稼働依頼支払いステータス ユニットテスト
 */

class DriverTaskRefundStatusTest extends TestCase
{
    private $section = "稼働依頼支払いステータス";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/driver-task-refund-status" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/driver-task-refund-status/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
