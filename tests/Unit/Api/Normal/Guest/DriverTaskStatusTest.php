...
/**
 * 稼働依頼ステータス 一覧 ユニットテスト
 */

class DriverTaskStatusTest extends TestCase
{
    private $section = "稼働依頼ステータス一覧";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/driver-task-status" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/driver-task-status/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
