...
class DriverTaskPaymentStatusTest extends TestCase
{
    private $section = "稼働依頼ステータス 取得";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/driver-task-payment-status" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/driver-task-payment-status/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
