...
/**
 * ドライバーへのレビュー公開ステータス ユニットテスト
 */

class DriverTaskReviewPublicStatusTest extends TestCase
{
    private $section = "ドライバーへのレビュー公開ステータス";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/driver-task-review-public-status" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/driver-task-review-public-status/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
