...
class DeliveryOfficeTypeTest extends TestCase
{
    private $section = "依頼者の種類";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/delivery-office-type" . $query_text;
    ...
    public function testShow()
    {
        ...
        $url = "/api/guest/delivery-office-type/show/2" . $query_text;
        $response = $this->getJson($url, $headers);
