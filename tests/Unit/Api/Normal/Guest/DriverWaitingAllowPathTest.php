...
/**
 * 登録審査中ドライバーのアクセス権限パス ユニットテスト
 */
class DriverWaitingAllowPathTest extends TestCase
{
    private $section = "登録審査中ドライバーのアクセス権限パス";
    ...
    public function testIndex()
    {
        ...
        $url = "/api/guest/allow-path/driver-waiting" . $query_text;
