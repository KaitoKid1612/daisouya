      ...
      <div class="bl_edit_inner">
        ...
        <div class="bl_edit_inner_content">
          <section class="bl_edit_inner_content_data">
            <form action="{{ route('admin.delivery_office_task_review.update', ['review_id' => $review->id]) }}" method="POST" class="js_confirm">
                    ...
                    <select name="review_public_status_id" id="review_public_status_id">
                      ...
                      @foreach ($review_public_status_list as $status)
                        <option value="{{ $status->id }}"
                          {{ $status->id == old('review_public_status_id', $review->review_public_status_id) ? 'selected' : '' }}>
                          {{ $status->name ?? '' }}
                        </option>
                      @endforeach
                    </select>
