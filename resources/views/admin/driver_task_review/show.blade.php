      ...
      <div class="bl_show_inner_content">
        <div class="bl_show_inner_content_handle">
          <div class="bl_show_inner_content_handle_item">
            <a href="{{ route('admin.driver_task_review.edit', ['review_id' => $review->id]) }}" class="c_btn">編集</a>
          </div>
          <div class="bl_show_inner_content_handle_item">
            <form action="{{ route('admin.driver_task_review.destroy', ['review_id' => $review->id]) }}" method="POST" class="js_confirm">
              @csrf
