...
/**
 * (ドライバー)ログインユーザーが所持していない登録営業所IDを指定した場合にバリデートされる。
 */
class HasDriverRegisterDeliveryOfficeMemoRule implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        ...
        $register_office = DriverRegisterDeliveryOfficeMemo::select()
        ->where([
            ['id', $value],
            ['driver_id', $login_id]
        ])
