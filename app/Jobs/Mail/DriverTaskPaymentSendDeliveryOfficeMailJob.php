...
/**
 * 稼働依頼の決済成否に関するメールのジョブ to 依頼者
 */
class DriverTaskPaymentSendDeliveryOfficeMailJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            Mail::to($to_office)->send(new DriverTaskPaymentSendDeliveryOfficeMail($data_mail)); // 送信
            $msg = 'メールを送信しました。';
            $log_level = 7;
            $notice_type = 1;
        } catch (\Throwable $e) {
